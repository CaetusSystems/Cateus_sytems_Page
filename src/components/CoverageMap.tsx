...
const CITIES: City[] = [
  ...
  { name: "Vespasiano", coords: [-19.6919, -43.9227], tier: "presencial", label: TIER_LABEL.presencial },
  { name: "Pedro Leopoldo", coords: [-19.6183, -44.0428], tier: "presencial", label: TIER_LABEL.presencial },
  { name: "Matozinhos", coords: [-19.5583, -44.0864], tier: "presencial", label: TIER_LABEL.presencial },
  { name: "Confins", coords: [-19.6339, -43.9706], tier: "presencial", label: TIER_LABEL.presencial },
  { name: "Capim Branco", coords: [-19.5556, -44.1264], tier: "presencial", label: TIER_LABEL.presencial },
  { name: "Jatobá", coords: [-19.5522, -43.9033], tier: "presencial", label: TIER_LABEL.presencial },
  { name: "Belo Horizonte", coords: [-19.9167, -43.9345], tier: "agendamento", label: TIER_LABEL.agendamento },
  { name: "Santa Luzia", coords: [-19.7697, -43.8514], tier: "agendamento", label: TIER_LABEL.agendamento },
  { name: "Jaboticatubas", coords: [-19.5108, -43.7447], tier: "agendamento", label: TIER_LABEL.agendamento },
  { name: "Serra do Cipó", coords: [-19.3402, -43.6103], tier: "agendamento", label: TIER_LABEL.agendamento },
  { name: "São José de Almeida", coords: [-19.4544, -43.8189], tier: "agendamento", label: TIER_LABEL.agendamento },
];
    ...
    <div className="relative isolate z-0 aspect-[16/10] w-full overflow-hidden rounded-xl border border-border/60 bg-muted/30">
      ...
      <div className="absolute left-3 top-3 z-[500] space-y-1 rounded-lg border border-border/70 bg-background/95 px-3 py-2 text-[11px] shadow-lg backdrop-blur">
        <div className="flex items-center gap-2">
          <span className="inline-block h-2.5 w-2.5 rounded-full" style={{ background: TIER_COLOR.sede }} />
          <span className="text-foreground">Sede</span>
        </div>
        <div className="flex items-center gap-2">
          <span className="inline-block h-2.5 w-2.5 rounded-full" style={{ background: TIER_COLOR.presencial }} />
          <span className="text-foreground">Presencial</span>
        </div>
        <div className="flex items-center gap-2">
          <span className="inline-block h-2.5 w-2.5 rounded-full" style={{ background: TIER_COLOR.agendamento, opacity: 0.7 }} />
